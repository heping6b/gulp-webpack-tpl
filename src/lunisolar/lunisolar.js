...
import lunarData from './const/lunarData';
...
const solarLunar = {
  ...
  lYearDays: function (y) {
    ...
    for (i = 0x8000; i > 0x8; i >>= 1) {
      sum += (solarLunar.lunarData[y - 1900] & i) ? 1 : 0;
    }
  ...
  leapMonth: function (y) { //闰字编码 \u95f0
    return (solarLunar.lunarData[y - 1900] & 0xf);
  },
  ...
  leapDays: function (y) {
    if (solarLunar.leapMonth(y)) {
      return ((solarLunar.lunarData[y - 1900] & 0x10000) ? 30 : 29);
    }
    return (0);
  },
  ...
  monthDays: function (y, m) {
    ...
    return ((solarLunar.lunarData[y - 1900] & (0x10000 >> m)) ? 30 : 29);
  },
